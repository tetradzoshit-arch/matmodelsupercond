...
def main():
    ...
    with st.expander("🔬 Фізичні принципи"):
        ...
        **Надпровідний стан (T < Tₐ):**
        - Рівняння Лондонів: струм росте лінійно/квадратично через відсутність опору
        - Ефект Мейснера: виключення магнітного поля
    ...
    with st.expander("📊 Про аналіз даних"):
        ...
        **Параметри ніобію:**
        - Температура кипіння рідкого гелію: **4.2 K**
        - Температура кипіння рідкого азоту: **77 K**
        - Робоча температура часто вибирається між цими значеннями
        """)

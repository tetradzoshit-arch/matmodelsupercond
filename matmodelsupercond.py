...
def main_page():
    ...
    # Інформаційні розділи - окремі елементи без вкладеності
    st.markdown("---")
    
    # Інструкція
    instructions_expander = st.expander("ℹ️ Інструкція користування", key="instructions_unique_123")
    ...
    # Фізичні принципи
    physics_expander = st.expander("🔬 Фізичні принципи", key="physics_unique_456")
    ...
    # Аналіз даних
    analysis_expander = st.expander("📊 Про аналіз даних", key="analysis_unique_789")
    ...
    # Фізичні константи
    constants_expander = st.expander("🧮 Фізичні константи ніобію", key="constants_unique_012")
    with constants_expander:

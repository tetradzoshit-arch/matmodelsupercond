...
def main_page():
    ...
    # Створюємо 3 колонки для інформаційних розділів
    info_col1, info_col2, info_col3 = st.columns(3)
    
    with info_col1:
        with st.expander("ℹ️ Інструкція користування", key="instructions_expander_main"):
            st.markdown("""
    ...
    with info_col2:
        with st.expander("🔬 Фізичні принципи", key="physics_expander_main"):
            st.markdown("""
    ...
    with info_col3:
        with st.expander("📊 Про аналіз даних", key="analysis_expander_main"):
            st.markdown("""
            **Фізичний аналіз:**
    ...
    # Окремий expander для фізичних констант
    with st.expander("🧮 Фізичні константи ніобію", key="constants_expander_main"):
